        ...
        <div class="main-wrap">
            ...
            <div class="user-orderinfo">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">卖家订单详情</strong> / <small>Order&nbsp;details</small></div>
                </div>
                <hr/>
                <!--进度条-->
                        ...
                        <a href="#">
                            ...
                            <c:if test="${orderUserResponse.orderState == 4}">
                                <div class="latest-logistics">
                                    <p class="text">已签收,签收人电话号码：${orderUserResponse.sellerPhone}，感谢使用圆通快递，期待再次为您服务</p>
                                    <div class="time-list">
                            ...
                            <c:if test="${orderUserResponse.orderState == 3}">
                                <div class="latest-logistics">
                                    <p class="text">卖家已经发货，发货地址：${orderUserResponse.stationStart}</p>
                                    <div class="time-list">
                                            <%--<span class="date">2015-12-19</span><span class="week">周六</span><span class="time">15:35:42</span>--%>
                                    </div>
                                    <div class="inquire">
                    ...
                    <div class="order-addresslist">
                        <div class="order-address">
                            ...
                            <p class="new-tit new-p-re">
                                <span class="new-txt">xxx</span>
                                <span class="new-txt-rd2">${orderUserResponse.sellerPhone}</span>
                            </p>
                                ...
                                <div class="order-right">
                                    ...
                                    <div class="move-right">
                                        ...
                                        <li class="td td-change">
                                            <c:if test="${orderUserResponse.orderState == 2}">
                                                <a href="${pageContext.request.contextPath }/user-order-send-execute/${orderUserResponse.orderId}">
                                                    <div class="am-btn am-btn-danger anniu">确认发货</div>
                                                </a>
                                            </c:if>
