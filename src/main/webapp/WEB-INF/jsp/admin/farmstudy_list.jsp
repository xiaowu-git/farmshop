            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title  am-cf">学堂列表</div>
                    </div>
                    <div class="widget-body  am-fr">
                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="admin-addFarmstudy-show" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                            <form action="${pageContext.request.contextPath }/admin-farmstudy-search-show" method="get">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    <input type="text" class="am-form-field" name="farmstudyName" placeholder="请输入学堂标题">
                        ...
                        <div class="am-u-sm-12">
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                ...
                                <c:forEach items="${requestScope.pageFarmStudies }" var="farmstudy">
                                    <tr class="gradeX">
                                        <td>
                                        ...
                                        <td class="am-text-middle">
                                            <div class="tpl-table-black-operation">
                                                ...
                                                <a href="${pageContext.request.contextPath }/admin-farmstudy-remove-execute/${farmstudy.farmstudyId}" class="tpl-table-black-operation-del">
                            ...
                            <div class="am-u-lg-12 am-cf" style="font-size:14px;">
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        <li>
                                            <a href="${pageContext.request.contextPath }/admin-farmstudy-list-show?page=${requestScope.pagePoint - 1 }">«</a>
                                        </li>
...
<script type="text/javascript">
    $(function () {
        $("#skipBtn").on("click", function () {
            ...
            window.location = "${pageContext.request.contextPath}/admin-farmstudy-list-show?page=" + page;
        });
