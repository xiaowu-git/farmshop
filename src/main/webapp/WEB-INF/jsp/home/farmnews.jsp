            ...
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <div class="search-content">
                    ...
                    <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                        <c:forEach items="${requestScope.pagefsFarmnews }" var="pagefsFarmnew">
                            <li>
                                <a href="${pageContext.request.contextPath }/user-farmnews-show?farmnewsId=${pagefsFarmnew.farmnewsId}">
                                    <div class="i-pic limit">
                                        <img src="${pageContext.request.contextPath }/${pagefsFarmnew.farmnewsPicture}"/>
                                        <p class="title fl">${pagefsFarmnew.farmnewsTitle}</p>
                                        <p class="price fl">
                                            <b>作者</b>
                                            <strong>${pagefsFarmnew.userId}</strong>
                                        </p>
                                        <p class="number fl">
                                            <span><fmt:formatDate value="${pagefsFarmnew.effectiveTime}" type="both"/></span>
                                        </p>
                                    </div>
                                </a>
                            </li>
                ...
                <c:if test="${requestScope.pagePoint != null}">
                    <ul class="am-pagination am-pagination-right" id="farmnews_page">
                        <li class=""><a href="${pageContext.request.contextPath }/farmnews-list?page=${requestScope.pagePoint - 1 }">«</a></li>
                        <li class="am-active"><a>当前第${requestScope.pagePoint }页(共${requestScope.pageMax }页)</a></li>
                        <li><a href="${pageContext.request.contextPath }/farmnews-list?page=${requestScope.pagePoint + 1 }">&raquo;</a></li>
                    </ul>
                </c:if>
            </div>
