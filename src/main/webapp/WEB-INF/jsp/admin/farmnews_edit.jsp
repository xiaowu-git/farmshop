                    ...
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form">
                                <input id="farmnews-id" type="hidden" value="${farmnews.farmnewsId}">
                                <div class="am-form-group">
                                    <label for="farmnews-name" class="am-u-sm-3 am-form-label">标题 <span class="tpl-form-line-small-title">Title</span></label>
                                    <div class="am-u-sm-9">
                                        <input id="farmnews-name" type="text" class="tpl-form-input" placeholder="请输入标题文字" value="${farmnews.farmnewsName}">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select id="farmnews-user" data-am-selected="{maxHeight: 200}" style="display: none;">
                                            <option value='${farmnews.userId}'>${farmnewsUser}</option>
                                        </select>
                                    </div>
                                </div>
                               <%-- <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img id="preview" src="${pageContext.request.contextPath }/${farmnews.farmnewsPicture}" alt="">
                                            </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="farmnews-info" placeholder="请输入文章内容" >${farmnews.farmnewsInfo1}<br>${farmnews.farmnewsInfo2}</textarea>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $("#want-addfarmnews").click(function(){
        ...
        var farmnewsId = $('#farmnews-id').val();
        ...
        formData.append("farmnewsId", farmnewsId);
        ...
        $.ajax({
            url:"${pageContext.request.contextPath }/admin-farmnews-edit-execute",
            type:'post',
            dataType:'json',
            data:formData,
            cache : false,
