    ...
    <div class="col-main">
        <div class="main-wrap">
            ...
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">我要采购</strong> / <small>Want&nbsp;to&nbsp;procurement</small></div>
            </div>
            <hr/>
            <div class="comment-list">
                ...
                <div class="m-progress">
                    <div class="m-progress-list">
							<span class="step-1 step">
                                ...
                                <p class="stage-name">买家申请<br>采购</p>
                            </span>
                ...
                <div class="m-prod-main">
                    <div class="item-comment">
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <select data-am-selected="{maxHeight: 300}" id="prod-type" onchange="">
                                    <%--<option value="a" selected>仅采购</option>--%>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            <label for="prod-money" class="am-form-label">采购单价</label>
                            <div class="am-form-content">
                        ...
                        <div class="am-form-group">
                            <label for="prod-number" class="am-form-label">采购数量</label>
                            <div class="am-form-content">
                                <input type="text" id="prod-number" placeholder="如：100">
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="prod-expiration" class="am-form-label">截止时间</label>
                            <div class="am-form-content">
                                <input type="date" id="prod-expiration" placeholder="如：2019年12月1日">
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="prod-info" class="am-form-label">采购说明<span>（可不填）</span></label>
                            <div class="am-form-content">
                                <textarea placeholder="请输入采购说明" id="prod-info"></textarea>
                            </div>
                        </div>

                    </div>
                    <label for="prod-picture" class="am-form-label">采购图片</label>
...
<script type="text/javascript">
    ...
    <!--点击提交按钮后执行操作-->
    $("#want-procurement").click(function(){
        ...
        var prodEexpiration = $('#prod-expiration').val();
        ...
        if(null == prodMoney || "" == prodMoney){
            toastr.options = {positionClass: "toast-top-center"};
            toastr["error"]("请您填写采购单价！");
            return false;
        }
        if(prodMoney.length > 5){
            toastr.options = {positionClass: "toast-top-center"};
            toastr.warning("请您正确填写采购单价!");
            return false;
        }
        if(null == prodNum || "" == prodNum){
            toastr.options = {positionClass: "toast-top-center"};
            toastr["error"]("请您填写采购数量！");
            return false;
        }
        if(prodNum.length > 5){
            toastr.options = {positionClass: "toast-top-center"};
            toastr.warning("请您正确填写采购数量!");
            return false;
        }
        if(null == prodEexpiration || "" == prodEexpiration){
            toastr.options = {positionClass: "toast-top-center"};
            toastr["error"]("请您填写采购截止日期！");
            return false;
        }
        if(null != prodInfo || "" != prodInfo){
            if(prodInfo.length > 50){
                toastr.options = {positionClass: "toast-top-center"};
                toastr.warning("请您正确填写采购说明!");
                return false;
            }
        }
        ...
        formData.append("prodEexpiration",  prodEexpiration);
        formData.append("prodInfo",  prodInfo);
        formData.append("prodPicture",  prodPicture);


        $.ajax({
            url:"${pageContext.request.contextPath }/user-wantprocurement-execute",
            type:'post',
            dataType:'json',
            data:formData,
            cache : false,
            ...
            success:function(data){
                ...
                if(data.success){
                    ...
                    toastr.options = {positionClass: "toast-top-center"};
                    toastr["error"](data.msg ? data.msg : "采购失败");
                }
            }
            ,error:function(e){
