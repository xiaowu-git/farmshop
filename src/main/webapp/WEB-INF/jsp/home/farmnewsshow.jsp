    ...
    <div class="am-u-md-9">
        <article class="blog-main">
            <h3 class="am-article-title blog-title">
                <a>${fsFarmnews.farmnewsTitle }</a>
            </h3>
            <h4 class="am-article-meta blog-meta">作者：${fsFarmnews.userId }</h4>
            <h4 class="am-article-meta blog-meta">时间：<fmt:formatDate value="${fsFarmnews.effectiveTime}" type="date"/></h4>

            <div class="am-g blog-content">
                <div class="am-u-sm-12">
                    <p>${fsFarmnews.farmnewsInfo1 }</p>

                    <div class="">
                        <li><img src="${pageContext.request.contextPath }/${fsFarmnews.farmnewsPicture }"/></li>
                    </div>

                    <br/>

                    <p>${fsFarmnews.farmnewsInfo2 }</p>
                </div>
